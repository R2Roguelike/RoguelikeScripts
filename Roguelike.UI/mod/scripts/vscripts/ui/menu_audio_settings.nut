...
void function InitAudioMenu()
{
	...
	SetupButton( file.classicMusicSwitch, "Disable Singleplayer Music", "Disables all music in the singleplayer campaign. The volume control didn't work."+
	"\n^F4D5A600May require restart to take effect." )
