...
void function FireArcBall( entity weapon, vector pos, vector dir, bool shouldPredict, float damage = 1.0, bool isCharged = false )
{
	entity owner = weapon.GetWeaponOwner()
	...
	if ( bolt != null )
	{
		...
		bolt.SetProjectileLifetime( lifetime )
			...
			ballLightning.e.ballLightningData.damageToPilots = weapon.GetWeaponSettingInt(eWeaponVar.damage_near_value) * damage
			ballLightning.e.ballLightningData.damage = weapon.GetWeaponSettingInt(eWeaponVar.damage_near_value_titanarmor) * damage
