...
var function OnWeaponPrimaryAttack_titanweapon_stun_laser( entity weapon, WeaponPrimaryAttackParams attackParams )
{
	...
	#if SERVER
	if (Roguelike_HasMod( weaponOwner, "instant_stun" ))
	{
...
void function StunLaser_DamagedTarget( entity target, var damageInfo )
{
	...
	{
		int shieldRestoreAmount = target.GetArmorType() == ARMOR_TYPE_HEAVY ? 9999 : 250 // always a full shield restore
		...
		if (Roguelike_HasMod( attacker, "stun_arm" ))
		{
