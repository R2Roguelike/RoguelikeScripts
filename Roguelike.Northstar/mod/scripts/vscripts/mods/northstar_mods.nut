...
void function Northstar_RegisterMods()
{
    ...
    }
    {
        ...
        mod.description = "Firing a Cluster Missile will cause a <red>very large explosion.</>"
        mod.shortdesc = "Cluster Missiles fired will\ncause a <red>big explosion."
        mod.cost = 3
    ...
    }
    {
        ...
        mod.description = "<cyan>-10% Railgun Charge Time.</>\n\nWhen Fulminate is at maximum, the crit is <cyan>guranteed.</>"
        mod.shortdesc = "When Fulminate is maxed, the crit is guranteed.\n<red>Fulminate accumulates slower.</>"
        mod.cost = 1
        mod.chip = TITAN_CHIP_WEAPON
    }
    {
    ...
    }
    {
        ...
        mod.description = "<cyan>-10% Railgun Charge Time.</>\n\nFully charged Railgun shots <cyan>get +50% Projectile Speed,</> and leave the enemy <cyan>Traumatized,</> reducing their damage output by 50% and <cyan>increasing Crit DMG against them by 35%."
    ...
    }
    {
        ...
        mod.description = "<cyan>-10% Railgun Charge Time.</>\n\nThe railgun's base damage increases with <cyan>Ability Power</>.\n\n<note>1 Ability Power = +1% Base Damage.</>"
        mod.shortdesc = "Railgun Base DMG increases relative\nto your <cyan>Ability Power</> stat."
        mod.cost = 3
        mod.chip = TITAN_CHIP_WEAPON
    }
    {
        ...
        mod.description = "<cyan>+10% Base Railgun DMG.</>\n\nThe Railgun does not lose charge when hipfiring. <cyan>-75% Spread,</> <red>-50% Damage in Hipfire."
        mod.shortdesc = "Railgun No-Scopes keep charge.\n<cyan>-75% Spread,</> <red>-50% Damage in Hipfire."
        mod.cost = 2
        mod.chip = TITAN_CHIP_WEAPON
    }
}
