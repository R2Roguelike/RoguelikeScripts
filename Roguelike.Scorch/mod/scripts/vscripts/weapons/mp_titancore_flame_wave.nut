global function FlameCore_IsAvailable
...
bool function FlameCore_IsAvailable( entity weapon )
{
	...
	if ( !IsCoreChargeAvailable( titan, soul ) && (!titan.IsPlayer() || !titan.GetPlayerNetBool("coreAgain")) )
	{
		return false
	}
