...
const float DAMAGE_AGAINST_TITANS 			= 50.0   //150
...
var function OnWeaponPrimaryAttack_titanweapon_tesla_node( entity weapon, WeaponPrimaryAttackParams attackParams )
{
	...
	if (owner.IsPlayer() && !OnWeaponAttemptOffhandSwitch_CheckShield( weapon ))
		return 0
	...
	#endif
	Archon_ConsumeShield( owner, weapon.GetWeaponSettingInt(eWeaponVar.ammo_per_shot))
	return 1
}
