...
void function StormCore_Init()
{
	...
	PrecacheParticleSystem( FX_EMP_GLOW )
		...
		AddDamageCallbackSourceID( eDamageSourceId.mp_titancore_storm_core_smoke, StormCoreOnDamage )
	#endif
}
...
void function StormCoreSmokescreen( entity bolt, asset fx, entity owner )
{
	...
	smokescreen.damageSource = eDamageSourceId.mp_titancore_storm_core_smoke
